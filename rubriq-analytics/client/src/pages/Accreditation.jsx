...
import { Shield, Download, Check, FileText, Archive, Zap } from 'lucide-react';
      ...
      {archives.length > 0 && (
        <div className="card overflow-hidden">
          ...
          <table className="min-w-full">
            <thead><tr><th className="table-th">Pack Title</th><th className="table-th">Date</th><th className="table-th">Components</th><th className="table-th">Generated By</th><th className="table-th">Status</th><th className="table-th">Action</th></tr></thead>
            <tbody>
              {archives.map(a => (
                <tr key={a.id} className="hover:bg-gray-50">
                  ...
                  <td className="table-td"><button className="btn-ghost py-1 text-xs"><Download size={13} />Download</button></td>
                </tr>
              ))}
            </tbody>
          </table>
